...
CALL .\DofusRecompiler.bat DofusInvoker_4.swf DofusInvoker_5.swf com.ankamagames.dofus.misc.interClient.InterClientKeyManager pingNext InterClientKeyManager_pingNext.pcode
CALL .\DofusRecompiler.bat DofusInvoker_5.swf DofusInvoker_6.swf com.ankamagames.dofus.logic.game.roleplay.managers.MountAutoTripManager initNewTrip MountAutoTripManager_initNewTrip.pcode
CALL .\DofusRecompiler.bat DofusInvoker_6.swf DofusInvoker_7.swf com.ankamagames.dofus.misc.utils.CursorConstant init Cursor.pcode
